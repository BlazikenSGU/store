...
if(isset($_POST['update_product'])){
    ...
    $update_product = $conn->prepare("UPDATE `products` SET name = ?, category = ?,size = ?, details = ?, price = ? WHERE id = ?");
    $update_product->execute([$name, $category,$size, $details, $price, $pid]);
...
<html lang="en">
    ...
    <body>
        ...
        <section class="update-product">
            ...
            <h1 class="title">CHỈNH SỬA CHI TIẾT SẢN PHẨM</h1>
            <?php
            ...
            <?php
                    ...
                    echo '<p class="empty">khong tim san pham!</p>';
                }

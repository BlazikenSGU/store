        ...
        <section class="cart">
            ...
            <div class="box-container">
                ...
                <form action="" method="POST" class="box">
                        <a href="cart.php?delete=<?= $fetch_cart['id'];?>" class="fas fa-times" onclick="return confirm('delete this from wishlist?');"></a>
                        <a href="view_page.php?pid=<?= $fetch_cart['pid'];?>" class="fas fa-eye"></a>
                        <img src="uploaded_img/<?= $fetch_cart['image'];?>" alt="">
                        <div class="name"><?= $fetch_cart['name'];?></div>
                        <div class="price"><?= $fetch_cart['price'];?>vnđ</div>
                        <select name="size" class="box1" >                                     
                                <option value=""><?= $fetch_cart['size']; ?></option>
                        ...
                        <div class="sub-total">
                            Thành tiền: <span><?= $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?> vnđ</span>
                        </div>
                </form>
                <?php
            ...
            <div class="cart-total">
                    <p>TỔNG HÓA ĐƠN: <span><?= $grand_total; ?></span>vnđ </p>
